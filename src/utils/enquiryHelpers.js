 ...
 * These functions have no side effects and are fully unit-testavle.
 */
...
/**
 * Validates and enquiry payload.
 * @param {object} data - Raw form/API payload
...
/**
 * Builds a clean enquiry object from validated data.
 * @param {object} data - Validated payload
 * @param {string} [idOverride] - Optional ID (useful in tests)
 * @returns {object} Enquiry record
 */
...
/**
 * Returns true if the transition from currentStatus > newStatus is allowed.
...
/**
 * Formats an enquiry for customer-visibile display.
